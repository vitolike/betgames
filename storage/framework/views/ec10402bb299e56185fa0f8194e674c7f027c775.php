                        ...
                        <div class="bet-form">
                            ...
                            <div class="command-type btnToggle">
								<button class="btn-bet bet-red" data-team="red">
									<div class="bet-chance">
										<div class="chance-text">
											<span id="red_persent"><?php echo e($chances[0]); ?>%</span><br>Roxo
								...
								<button class="btn-bet bet-blue" data-team="blue">
									<div class="bet-chance">
										<div class="chance-text">
											<span id="blue_persent"><?php echo e($chances[1]); ?>%</span><br>Azul
				...
				<div class="game_Wheel">
					<div class="progress-wrap">
						<div class="progress-item left">
							<div class="title">Aposta Mínima: <span id="minBet"><?php echo e($settings->battle_min_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
							<div class="title">Aposta Máxima: <span id="maxBet"><?php echo e($settings->battle_max_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
						</div>
						<div class="progress-item right">
							<div class="title">Partida #<span id="gameId"><?php echo e($game->id); ?></span></div>
						</div>
					</div>
						...
						<div class="wheel-content">
							...
							<div class="time">
								<div class="block">
									...
									<div class="value bank" id="value" style="color: #7b8893"><span id="red_sum" style="color: #5e0ea1;"><?php echo e($bank[0]); ?></span>/<span id="blue_sum" style="color: #4986f5;"><?php echo e($bank[1]); ?></span></div>
									<div class="line"></div>
					...
					<table class="table">
						<tbody>
							...
							<tr>
								...
								<td><span class="bet-type bet_<?php echo e($b->color); ?>"><?php echo e($b->color == 'red' ? 'Roxo' : 'Azul'); ?></span></td>
							</tr>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</tbody>
					</table>
