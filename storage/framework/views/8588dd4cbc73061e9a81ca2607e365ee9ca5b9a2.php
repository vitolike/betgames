			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="dtable">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo e($bot->time == 0 ? 'Tempo Todo' : ''); ?><?php echo e($bot->time == 1 ? '6:00 as  12:00' : ''); ?><?php echo e($bot->time == 2 ? '12:00 as 18:00' : ''); ?><?php echo e($bot->time == 3 ? '18:00 as 00:00' : ''); ?><?php echo e($bot->time == 4 ? '00:00  as 06:00' : ''); ?></td>
						<td><a href="/admin/user/<?php echo e($bot->id); ?>" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Editar"><i class="la la-edit"></i></a><a href="/admin/bots/delete/<?php echo e($bot->id); ?>" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="APAGAR"><i class="la la-trash"></i></a></td>
					</tr>
