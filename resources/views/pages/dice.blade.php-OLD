						...
						<div class="game-area">
							<div class="progress-wrap">
								<div class="progress-item left">
									<div class="title">Aposta Mínima: <span id="minBet">{{$settings->dice_min_bet}}</span> <svg class="icon icon-coin balance balance"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
									<div class="title">Aposta Máxima: <span id="maxBet">{{$settings->dice_max_bet}}</span> <svg class="icon icon-coin balance balance"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
								</div>
							</div>
